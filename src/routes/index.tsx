    ...
    <>
      <div className="relative">
        ...
        <div className="shell pb-6 pt-10 sm:pt-14">
          ...
          <p className="mt-5 max-w-xl text-[15px] leading-relaxed text-muted">
            ...
            and digital infrastructure — with human approval at every step.
          </p>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-2 text-[12.5px]">
            ...
            <a
              ...
              className="focus-ring inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.08em] text-gold hover:text-gold-soft"
            >
              Browse as an agent →
            </a>
            <span className="text-faint">·</span>
            <a
              href="/agent-commerce.json"
              className="focus-ring inline-flex items-center gap-1.5 font-mono text-[11px] uppercase tracking-[0.08em] text-gold hover:text-gold-soft"
            >
              View API manifest →
            </a>
      ...
      <Section className="!pt-2">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {featured.map((operator) => (
            <OperatorCard key={operator.id} operator={operator} compact />
          ))}
        </div>
      </Section>
