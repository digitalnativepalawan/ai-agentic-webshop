  ...
  head: () => ({
    meta: [
      ...
      { name: "twitter:card", content: "summary_large_image" },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/T9Th5uPVO0aXJIb4F3X0QFtM7K13/social-images/social-1783215791797-WhatsApp_Image_2026-07-04_at_7.36.54_AM_(1).webp",
      },
      {
        name: "twitter:image",
        content:
